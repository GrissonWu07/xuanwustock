...
def _passing_low_price_evidence() -> dict:
    return {
        ...
        "artifact_ref": "mta:v1|domain=drill|run_id=unit|run_type=live_quant_drill|market=CN|stock_code=600519|checkpoint_at=2026-01-05T02%3A00%3A00Z|timeframe=30m|data_version=mta_v1",
        "source_status": "ready",
        "reason_code": "ok",
