...
def create_app(context: UIApiContext | None = None) -> FastAPI:
    ...
    for path, page in {
        "/api/ui/workbench": "workbench",
        "/api/ui/discover": "discover",
        "/api/ui/research": "research",
        "/api/ui/portfolio": "portfolio",
        "/api/ui/quant/live-sim": "live-sim",
        "/api/ui/quant/his-replay": "his-replay",
        "/api/ui/monitor/ai": "ai-monitor",
        "/api/ui/monitor/real": "real-monitor",
        "/api/ui/history": "history",
        "/api/ui/settings": "settings",
    }.items():
    ...
    for path, page, action in [
        ("/api/ui/workbench/actions/add-watchlist", "workbench", "add-watchlist"),
        ("/api/ui/workbench/actions/refresh-watchlist", "workbench", "refresh-watchlist"),
        ("/api/ui/workbench/actions/batch-quant", "workbench", "batch-quant"),
        ("/api/ui/workbench/actions/analysis", "workbench", "analysis"),
        ("/api/ui/workbench/actions/analysis-batch", "workbench", "analysis-batch"),
        ("/api/ui/workbench/actions/clear-selection", "workbench", "clear-selection"),
        ("/api/ui/workbench/actions/delete-watchlist", "workbench", "delete-watchlist"),
        ("/api/ui/discover/actions/item-watchlist", "discover", "item-watchlist"),
        ("/api/ui/discover/actions/batch-watchlist", "discover", "batch-watchlist"),
        ("/api/ui/discover/actions/run-strategy", "discover", "run-strategy"),
        ("/api/ui/research/actions/item-watchlist", "research", "item-watchlist"),
        ("/api/ui/research/actions/batch-watchlist", "research", "batch-watchlist"),
        ("/api/ui/research/actions/run-module", "research", "run-module"),
        ("/api/ui/portfolio/actions/analyze", "portfolio", "analyze"),
        ("/api/ui/portfolio/actions/refresh-portfolio", "portfolio", "refresh-portfolio"),
        ("/api/ui/portfolio/actions/schedule-save", "portfolio", "schedule-save"),
        ("/api/ui/portfolio/actions/schedule-start", "portfolio", "schedule-start"),
        ("/api/ui/portfolio/actions/schedule-stop", "portfolio", "schedule-stop"),
        ("/api/ui/quant/live-sim/actions/save", "live-sim", "save"),
        ("/api/ui/quant/live-sim/actions/start", "live-sim", "start"),
        ("/api/ui/quant/live-sim/actions/stop", "live-sim", "stop"),
        ("/api/ui/quant/live-sim/actions/reset", "live-sim", "reset"),
        ("/api/ui/quant/live-sim/actions/analyze-candidate", "live-sim", "analyze-candidate"),
        ("/api/ui/quant/live-sim/actions/delete-candidate", "live-sim", "delete-candidate"),
        ("/api/ui/quant/live-sim/actions/bulk-quant", "live-sim", "bulk-quant"),
        ("/api/ui/quant/his-replay/actions/start", "his-replay", "start"),
        ("/api/ui/quant/his-replay/actions/continue", "his-replay", "continue"),
        ("/api/ui/quant/his-replay/actions/cancel", "his-replay", "cancel"),
        ("/api/ui/quant/his-replay/actions/delete", "his-replay", "delete"),
        ("/api/ui/monitor/ai/actions/start", "ai-monitor", "start"),
        ("/api/ui/monitor/ai/actions/stop", "ai-monitor", "stop"),
        ("/api/ui/monitor/ai/actions/analyze", "ai-monitor", "analyze"),
        ("/api/ui/monitor/ai/actions/delete", "ai-monitor", "delete"),
        ("/api/ui/monitor/real/actions/start", "real-monitor", "start"),
        ("/api/ui/monitor/real/actions/stop", "real-monitor", "stop"),
        ("/api/ui/monitor/real/actions/refresh", "real-monitor", "refresh"),
        ("/api/ui/monitor/real/actions/update-rule", "real-monitor", "update-rule"),
        ("/api/ui/monitor/real/actions/delete-rule", "real-monitor", "delete-rule"),
        ("/api/ui/history/actions/rerun", "history", "rerun"),
        ("/api/ui/settings/actions/save", "settings", "save"),
    ]:
