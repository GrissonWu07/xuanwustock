...
对应动作：
- `POST /api/ui/discover/actions/item-watchlist`
...
对应动作：
- `POST /api/ui/research/actions/item-watchlist`
- `POST /api/ui/research/actions/batch-watchlist`
...
工作台下半区的股票分析会发起：
- 单股分析：`POST /api/ui/workbench/actions/analysis`
- 批量分析：`POST /api/ui/workbench/actions/analysis-batch`
...
对应动作：
- `POST /api/ui/workbench/actions/batch-quant`
...
| 动作 | 接口 |
|---|---|
| 保存配置 | `POST /api/ui/quant/live-sim/actions/save` |
| 启动模拟 | `POST /api/ui/quant/live-sim/actions/start` |
| 停止模拟 | `POST /api/ui/quant/live-sim/actions/stop` |
| 重置账户 | `POST /api/ui/quant/live-sim/actions/reset` |
| 单只候选分析 | `POST /api/ui/quant/live-sim/actions/analyze-candidate` |
| 删除候选股 | `POST /api/ui/quant/live-sim/actions/delete-candidate` |
| 批量跑候选池 | `POST /api/ui/quant/live-sim/actions/bulk-quant` |
...
| 动作 | 接口 |
|---|---|
| 发起区间回放 | `POST /api/ui/quant/his-replay/actions/start` |
