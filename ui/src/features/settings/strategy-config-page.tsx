...
const QUANT_UNIVERSE_LIFECYCLE_FIELDS: ProfitProtectionField[] = [
  ...
  { key: "active_upgrade_confirm_checkpoints", label: { zh: "升级确认检查点 active_upgrade_confirm_checkpoints", en: "Active confirm checkpoints active_upgrade_confirm_checkpoints" }, type: "number", path: ["active_upgrade_confirm_checkpoints"], step: 1 },
  ...
  { key: "retired_min_dwell_days", label: { zh: "退出最短天数 retired_min_dwell_days", en: "Retired min days retired_min_dwell_days" }, type: "number", path: ["retired_min_dwell_days"], step: 1 },
  ...
  { key: "cooling_review_batch_size", label: { zh: "冷却复评批量 cooling_review_batch_size", en: "Cooling review batch cooling_review_batch_size" }, type: "number", path: ["cooling_review_batch_size"], step: 1 },
  { key: "min_scan_coverage", label: { zh: "最小扫描覆盖 min_scan_coverage", en: "Minimum scan coverage min_scan_coverage" }, type: "number", path: ["min_scan_coverage"], step: 1 },
  { key: "trial_buy_threshold_delta", label: { zh: "观察 BUY 门槛增量 trial_buy_threshold_delta", en: "Trial BUY threshold delta trial_buy_threshold_delta" }, type: "number", path: ["trial_buy_threshold_delta"], step: 0.01 },
  ...
  { key: "guarded_buy_threshold_delta", label: { zh: "防守 BUY 门槛增量 guarded_buy_threshold_delta", en: "Guarded BUY threshold delta guarded_buy_threshold_delta" }, type: "number", path: ["guarded_buy_threshold_delta"], step: 0.01 },
  { key: "guarded_size_multiplier", label: { zh: "防守仓位倍率 guarded_size_multiplier", en: "Guarded size multiplier guarded_size_multiplier" }, type: "number", path: ["guarded_size_multiplier"], step: 0.05 },
  { key: "guarded_max_position_pct", label: { zh: "防守仓位上限 guarded_max_position_pct", en: "Guarded max position pct guarded_max_position_pct" }, type: "number", path: ["guarded_max_position_pct"], step: 0.5 },
  { key: "recovery_probe_exit_grace_hours", label: { zh: "恢复买入保护小时 recovery_probe_exit_grace_hours", en: "Recovery probe exit grace hours recovery_probe_exit_grace_hours" }, type: "number", path: ["recovery_probe_exit_grace_hours"], step: 1 },
  { key: "cooling_supplemental_buy_threshold_delta", label: { zh: "冷却补扫 BUY 门槛增量", en: "Cooling supplemental BUY threshold delta" }, type: "number", path: ["cooling_supplemental_buy_threshold_delta"], step: 0.01 },
  { key: "cooling_supplemental_size_multiplier", label: { zh: "冷却补扫仓位倍率", en: "Cooling supplemental size multiplier" }, type: "number", path: ["cooling_supplemental_size_multiplier"], step: 0.05 },
...
const ensureQuantUniverseLifecycleDefaults = (root: Record<string, unknown>, path: string[]) => {
  ...
  const defaults: Record<string, number | boolean> = {
    ...
    cooling_supplemental_max_position_pct: 2,
